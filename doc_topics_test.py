...
text_sim = 'ww-ii naval experts british marine'
doc = text_sim
...
print(get_top_docs(result_doc[0][0]))
print(result_doc[1][0])
print(result_doc[2][0])
print(result_doc[3][0])
print(result_doc[9][0])

doc_topics = []
for i in range(10):
    print(get_top_docs(result_doc[i][0]))
